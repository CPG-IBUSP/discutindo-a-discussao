...
Este relação é exarcebada por bons resultados.
...
Também chama a atenção que menos de % dos trabalhos sem indicação de excelência
...
consideradas de alto impacto potenacial, em função de sua avaliação nos demais quesitos.**
